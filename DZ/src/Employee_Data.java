public class Employee_Data {
    public static void main(String[] args) {
        Employee [] employee = new Employee[6];//Здесь я создаю объект employee типа Employee,но без наследования?
        ...
        employee[5].setPersonalName("Aleksandr Makedonskiy");
        employee[5].setOcupation("Conqueror");
        employee[5].seteMail("sashagay@gefestion.gr");
        employee[5].setPhoneNumber(10344588771595L);//Почему здесь хочет обязательно явно обозначить L?
        employee[5].setSalary(1144582);
        employee[5].setAge(27);
